...
require (
	...
	github.com/vlla-test-organization/qubership-core-lib-go-actuator-common/v2 v2.0.7
	github.com/vlla-test-organization/qubership-core-lib-go-error-handling/v3 v3.0.7
